...
public class AuthenticationAPI {
  ...
  public func login(withPayload payload: [String: Any], loginurl: String?, emailtemplate: String?, smstemplate: String?, g_recaptcha_response: String?, completionHandler: @escaping LRAPIResponseHandler) {
   ...
   public func socialIdentity(withAccessToken access_token: String, completionHandler: @escaping LRAPIResponseHandler) {
        LoginRadiusREST.apiInstance.sendGET(url: "identity/v2/auth/socialidentity", queryParams: [
            "apikey": LoginRadiusSDK.sharedInstance.apiKey,
            "access_token": access_token
        ], completionHandler: completionHandler)
    }
   ...
   public func linkSocialIdentities(withAccessToken access_token: String, candidatetoken: String, completionHandler: @escaping LRAPIResponseHandler) {
        LoginRadiusREST.apiInstance.sendPUT(url: "identity/v2/auth/socialidentity", queryParams: ["apikey": LoginRadiusSDK.sharedInstance.apiKey, "access_token": access_token], body: ["candidatetoken": candidatetoken], completionHandler: completionHandler)
    }
